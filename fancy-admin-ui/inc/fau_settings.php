...
function mw_enqueue_color_picker( $hook_suffix ) {
    ...
    wp_enqueue_script( 'my-script-handle', get_stylesheet_directory_uri() . '/lib/fancy-admin-ui/inc/fau-colorpicker.js', array( 'wp-color-picker' ), false, true );
}
...
class fau_color_settings {
    ...
    function register_fields() {
        ...
        add_settings_field('fau_primary_color', '<label for="fau_primary_color">'._x('Admin UI Primary Color:' , 'fau_primary_color' ).'</label>' , array(&$this, 'fields_html') , 'general' );
    }
...
class fau_secondary_color_settings {
    ...
    function register_fields() {
        ...
        add_settings_field('fau_secondary_color', '<label for="fau_secondary_color">'._x('Admin UI Secondary Color:' , 'fau_secondary_color' ).'</label>' , array(&$this, 'fields_html') , 'general' );
    }
    function fields_html() {
